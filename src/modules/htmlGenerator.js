 ...
 * Generates HTML components for inventory items
 * Follows Single Responsibility Principle - separated into component generators
 */
...
function generateItemCard(item) {
    return `
    <div class="item-card" data-item-id="${item.id}" data-floor="${escapeHtml(item.location.floor || '')}" data-room="${escapeHtml(item.location.room || '')}">
    ...
    <div class="quick-info-tooltip">
        ...
        <div class="tooltip-body">
            ...
            <div class="tooltip-row">
                ...
                <span class="tooltip-value">${escapeHtml(item.barcode || 'N/A')}</span>
            </div>
        </div>
    </div>`;
}
